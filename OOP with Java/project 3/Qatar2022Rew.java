...
public class Qatar2022Rew {
    ...
    public static void main(String[] args) {
        ...
        // decision loop
        while ((userChoice != 8 && !isOver) && (userChoice >= 1 && userChoice <= 8)) {
            if (userChoice == 1) {
            ...
            if(userChoice == 7)
            {
                ...
                for(int k = 0; k < groupA.getNumberOfTeams(); k++)
                {
                    for(int y = 0; y < groupA.getTeams()[k].getSquad().size(); y++)
                    {
                        if(groupA.getTeams()[k].getSquad().get(y).getMarketValue() > largestMarket)
                        {
                            largestMarket = groupA.getTeams()[k].getSquad().get(y).getMarketValue();
                        }
                    }
                }
                for(int k = 0; k < groupA.getNumberOfTeams(); k++)
                {
                    for(int y = 0; y < groupA.getTeams()[k].getSquad().size(); y++)
                    {
                        if(groupA.getTeams()[k].getSquad().get(y).getMarketValue() == largestMarket)
                        {
                            System.out.println(groupA.getTeams()[k].getSquad().get(y).toString());
                        }
                    }
                }
